...
(async () => {
  ...
  for (const m of ['0001_init.sql', '0003_fix_role_escalation.sql', '0004_gamma_model.sql', '0005_client_ready.sql', '0006_deletable.sql','0007_order_contact_and_gear.sql'])
    psql('gamma_sync', `${M}/${m}`);
  ...
  await office.waitForTimeout(150);
  await office.click('[data-gearpick="climbing"]');
  await office.waitForTimeout(150);
